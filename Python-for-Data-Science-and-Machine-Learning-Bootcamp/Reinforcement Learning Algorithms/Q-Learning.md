...
Methods for Determining Q-values 
	1. Temporal Difference : is calculated by comparing current state and action values of prev ones. It provides a way to learn directly from experience, without needing a model of the
enviroment.
